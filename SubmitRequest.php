...
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputRequestDescription" placeholder="Description" name="requestdesc">
    </div>
    <div class="form-group">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="inputAddress" placeholder="Present Address" name="requesteradd1">
      </div>
      <div class="form-group col-md-6">
        <label for="inputAddress2">Address Line 2</label>
        <input type="text" class="form-control" id="inputAddress2" placeholder="Permanent Address" name="requesteradd2">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
