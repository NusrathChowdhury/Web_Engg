...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-info"></i> <span>Requester
      Area</span>
  </p>
  <div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        ...
        <div class="text-center"><a class="btn btn-secondary mt-3 shadow-sm font-weight-bold" href="../index.php">Home</a></div>
      </div>
    </div>
  </div>
